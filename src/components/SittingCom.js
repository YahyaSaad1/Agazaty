        ...
        <div className="row">
            <div>
                <div className="box d-flex justify-content-between mt-3 col-sm-12 col-md-10 col-lg-8">
                    ...
                    <BtnLink name='تعديل' link='/editprofile' className='btn-outline-primary' />
                </div>
                <div className="box d-flex justify-content-between mt-3 col-sm-12 col-md-10 col-lg-8">
                    <h5 className="m-0 d-flex align-items-center">اعدادات الاشعارات</h5>
                    <BtnLink name='تعديل' link='/profile' className='btn-outline-primary' />
                </div>
                <div className="box d-flex justify-content-between mt-3 col-sm-12 col-md-10 col-lg-8">
                ...
                <div className="box d-flex justify-content-between mt-3 col-sm-12 col-md-10 col-lg-8">
                    <h5 className="m-0 d-flex align-items-center">اعدادات الإجازات</h5>
                    <BtnLink name='تعديل' link='/profile' className='btn-outline-primary' />
                </div>
            </div>
        </div>
