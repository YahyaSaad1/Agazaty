...
//                 </div>
//                 <div className="p-3">
//                     <BtnLink name='سجل الإجازات المرضية' link='/agazaty/sick' className="btn btn-primary m-0 ms-2 mb-2" />
//                 </div>
//             </div>
...
//                                         ? <Btn name="مقبولة" className="btn-success text-bold"/>
...
//                                         : <Btn name="مرفوضة" className="btn-danger text-bold"/>
//                                     }
//                                 </th>
//                             </tr>
//                         </thead>
