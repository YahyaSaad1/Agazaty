...
import '../CSS/LandingBageHeader.css'
...
function LandingPage() {
    ...
    const team = [
        ...
        },
        {
            ...
            fourthName: "محمود",
            socialMedia: {
                linkedIn: "mahmoud-nasr-821582229?",
                gitHub: "mahmoudalhawary",
                whatsapp: "01006132539",
                email: "alhawary11178@gmail.com",
            },
        },
        {
            id: 4,
    ...
    useEffect(() => {
        const handleScroll = () => {
            // إظهار/إخفاء الهيدر بناءً على التمرير
            if (window.scrollY > lastScrollY) {
                setIsVisible(false); // إخفاء الهيدر عند التمرير لأسفل
            } else {
                setIsVisible(true); // إظهار الهيدر عند التمرير لأعلى
            }
            setLastScrollY(window.scrollY);

            // إظهار/إخفاء زر Back to Top
    ...
    return (
        <>
            ...
            {/* الهيدر */}
            <header
                className={`mainBGColor mainTColor fixed-top z-50 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}
            >
                <div className="container d-flex justify-content-between align-items-center py-2 px-3">
                    <div>
                        <p className="logo mb-0 fs-2 text-white">Agazaty</p>
                    </div>
                    <div className=" d-flex align-items-center">

                        <Link
                            onClick={() => navigate('/u/WhoUs')}
                            className="btnHeader mx-2 text-white"
                        >
                            من نحن
                        </Link>
                        <Link
                            onClick={() => navigate('/u/OurService')}
                            className="btnHeader mx-2 text-white"
                        >
                            خدماتنا
                        </Link>
                        <Link
                            onClick={() => navigate('/u/CommonQuestion')}
                            className="btnHeader mx-2 text-white"
                        >
                            أسئلة شائعة
                        </Link>
                        <Link
                            onClick={() => navigate('/u/CallingUs')}
                            className="btnHeader mx-2 text-white"
                        >
                            اتصل بنا
                        </Link>
            ...
            <div className="p-3   justify-content-between " style={{ marginTop: "60px" }}>
                <div className='h-95'>
                    ...
                    <div>
                        ...
                        <h6 className="ps-3 pe-3">
                            <span>2 . تحسين الكفاءة:</span>                            <span style={{ fontSize: "16px", fontWeight: "400" }}>
                                تسريع معالجة الطلبات وتقليل الأخطاء الإدارية.                            </span>
                        </h6>
                        <h6 className="ps-3 pe-3">
                            <span>3 . تعزيز التوثيق:</span>                            <span style={{ fontSize: "16px", fontWeight: "400" }}>
                                إنشاء سجلات رقمية دقيقة وقابلة للتتبع.                            </span>
                        </h6>
                        <h6 className="ps-3 pe-3">
                            <span>4 . تجربة مستخدم مميزة:</span>                            <span style={{ fontSize: "16px", fontWeight: "400" }}>
                                واجهة سهلة الاستخدام لمتابعة الطلبات.                            </span>
                        </h6>
                        <h6 className="ps-3 pe-3">
                            <span>5 . إدارة الصلاحيات:</span>                            <span style={{ fontSize: "16px", fontWeight: "400" }}>
                                تخصيص أدوار واضحة لكل مستخدم.                            </span>
                        </h6>
                        <h6 className="ps-3 pe-3">
                        ...
                        <h6 className="pb-3 ps-3 pe-3">
                            <span>7 . تحقيق الشفافية:</span>                            <span style={{ fontSize: "16px", fontWeight: "400" }}>
                                عملية موثوقة تقلل الأخطاء اليدوية.                            </span>
                        </h6>
                    </div>
                ...
                <div>
                    ...
                    <div >
                        <div className='LandingSec'>
                            <h2 className=" text-center  ">فريق عمل المشروع</h2>
                        </div>
                                ...
                                return (
                                    <div className="   col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-3 ">
                                        <div className="card border border-1  shadow overflow-hidden  ">
                                            ...
                                            <div className="p-1 d-flex justify-content-center">
                                                {/* <Link
                                                className="p-1    text-black   text-center pt-2 hover-type"
                                                style={{ textDecoration: "none" }}
                                                to={`https://github.com/${member.socialMedia.gitHib}`}
                                                type="submit"
                                            > */}
